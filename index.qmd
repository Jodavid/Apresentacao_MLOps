...
1. **Modelos em Testes vs. Realidade:** Um modelo que funciona bem em um notebook com dados estáticos pode falhar em um ambiente de produção com dados dinâmicos.
...
**1. Logging:**
Cada predição feita pela sua API deve ser registrada. O que registrar?
